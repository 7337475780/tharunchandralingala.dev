...
export function LeetCode() {
  ...
  useEffect(() => {
    if (inView) {
      ...
      const totalTarget = 434;
      const accTarget = 73.59;
        ...
        <div className="w-full max-w-4xl bg-[var(--surface)] rounded-[24px] border border-[var(--border2)] p-8 md:p-12 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-stretch gap-12 relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-8 md:gap-12">
              <CircleChart label="Easy" value={168} max={250} color="green" inView={inView} />
              <CircleChart label="Medium" value={195} max={250} color="yellow" inView={inView} />
              <CircleChart label="Hard" value={71} max={100} color="red" inView={inView} />
            </div>
